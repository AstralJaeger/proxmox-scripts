...
# Base raw github URL
_raw_base="https://raw.githubusercontent.com/AstralJaeger/proxmox-scripts/main/lxc/nginx-proxy-manager"
# Operating system
_os_type=alpine
_os_version=3.12
# System architecture
...
pct start $_ctid
sleep 3
pct exec $_ctid -- sh -c "wget --no-cache -qO - https://raw.githubusercontent.com/AstralJaeger/proxmox-scripts/main/lxc/nginx-proxy-manager/setup.sh | sh"